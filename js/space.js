...
(function () {
  ...
  const DARK_COLORS = ["244,244,246", "62,230,255", "196,107,255", "255,94,126", "46,255,158"];
  const LIGHT_COLORS = ["91,72,232", "5,150,199", "139,63,232", "209,49,158"];
  const METEOR_COLORS = ["255,255,255", "160,235,255", "255,180,220", "190,255,215"];
